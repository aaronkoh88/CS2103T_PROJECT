...
//This class creates an object with the required attributes. Accessor and mutator methods are also 
//specified
...
//*********************Mutators***************************
	...
	{
		return"[Serial: "+serialNum+" folder name: "+ this.getFolder()+ " Task: " +this.getTaskDescription()+ " Details: " +this.getDetails() +" Priority: "+this.getPriority()+ "Date of Entry" +getDateOfEntry().get(Calendar.DAY_OF_MONTH)+ " deadline "+ this.getDeadLine().get(Calendar.DAY_OF_MONTH)+ " Reminder: " +this.getReminder().get(Calendar.DAY_OF_MONTH)+"]";
	}
}